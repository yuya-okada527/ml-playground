...
# movie_recommeder_ml_pipeline documentation build
...
from movie_recommeder_ml_pipeline import __version__ as release

# -- Project information -----------------------------------------------------

project = "movie_recommeder_ml_pipeline"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "movie_recommeder_ml_pipelinedoc"
...
latex_documents = [
    (
        master_doc,
        "movie_recommeder_ml_pipeline.tex",
        "movie_recommeder_ml_pipeline Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "movie_recommeder_ml_pipeline",
        "Project movie_recommeder_ml_pipeline codebase.",
        "Data-Science",
    )
]
